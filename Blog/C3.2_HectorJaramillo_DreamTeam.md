...
<p align="center">
    <img alt="SalidaDigital" src="../diagramas/C3.x_ArduinoEsquematicoEntradaDigital.png" width=650 height=350>
</p>

2. Analice y escriba el programa que se muestra a continuación.

<p align="center">
    <img alt="SalidaDigital" src="../diagramas/C3.x_ArduinoProgramaEntradaDigital.png" width=500 height=400>
</p>

3. Inserte imágenes que considere como evidencias para demostrar el resultado obtenido.

    **En la imagenes se muestra el circuito sin accionar el boton y el circuito pulsando el boton, lo mantuve presionado para que se alcanzara a percibir el cambio ya que el delay es muy poco.**

<p align="center">
    <img alt="circuito" src="../diagramas/C3.2_CA.png" width=600 height=400>
</p>

<p align="center">
    <img alt="circuito" src="../diagramas/C3.2_CA2.png" width=600 height=400>
</p>
